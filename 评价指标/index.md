...
&lt;div&gt;$$
P P ( S ) = P ( w _ { 1 } w _ { 2 } \cdots w_N ) ^ { - \frac { 1 } { N } } = \sqrt [ N ] { \frac { 1 } { P ( w _ { 1 } w _ { 2 } \cdots w _ { N }) } }\\
...
[^6]: [transE评价方法 - Sunder (xiangrongzeng.github.io)](https://xiangrongzeng.github.io/knowledge%20graph/transE-evaluation.html)
